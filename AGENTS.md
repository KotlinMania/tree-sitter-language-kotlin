# Agent guide - tree-sitter-language-kotlin

This file is the quick-reference operating contract for tree-sitter-language-kotlin. The longer
...
tree-sitter-language-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tree-sitter-language`](https://crates.io/crates/tree-sitter-language). Upstream Rust is the behavioral oracle while the

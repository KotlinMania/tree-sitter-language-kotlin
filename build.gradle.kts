...
kotlin {
    ...
    val xcf = XCFramework("NumBigint")

    macosArm64 {
        binaries.framework { baseName = "NumBigint"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "NumBigint"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "NumBigint"
        flattenPackage = "io.github.kotlinmania.numbigint"
    }

    android {
        namespace = "io.github.kotlinmania.numbigint"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "num-bigint-kotlin", version.toString())

    pom {
        name.set("num-bigint-kotlin")
        description.set("Kotlin Multiplatform port of rust-num/num-bigint - arbitrary precision integers")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/num-bigint-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/num-bigint-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/num-bigint-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/num-bigint-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.numbigint.codeql
